            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						...
						<li>
							<a href="{{route('show_product_backend')}}"><i class="fa fa-th-large nav_icon"></i>Products</a>
						</li>
						<li>
							<a href="{{route('show_productline')}}"><i class="fa fa-th-large nav_icon"></i>Productlines</a>
						</li>
						<!-- <li>
						...
						<li class="dropdown profile_details_drop">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
								<div class="profile_img">	
									<span class="prfil-img"><img src="{{asset('backend/images/a.png')}}" alt=""> </span> 
									<div class="user-name">
										<p>Wikolia</p>
